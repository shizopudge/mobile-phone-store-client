...
class _$_ProductModel extends _ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, title: $title, description: $description, images: $images, inStockCount: $inStockCount, cost: $cost, slug: $slug, color: $color, colorCode: $colorCode, storage: $storage, discount: $discount, model: $model)';
  }

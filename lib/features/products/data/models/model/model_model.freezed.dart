...
/// @nodoc
@JsonSerializable()
class _$_ModelModel implements _ModelModel {
  const _$_ModelModel(
      {required this.id,
      required this.name,
  ...
  @override
  String toString() {
    return 'ModelModel(id: $id, name: $name, pixelDensity: $pixelDensity, screenRefreshRate: $screenRefreshRate, screenDiagonal: $screenDiagonal, weight: $weight, screenResolution: $screenResolution, operatingSystem: $operatingSystem, displayType: $displayType, manufacturer: $manufacturer, products: $products)';
  }

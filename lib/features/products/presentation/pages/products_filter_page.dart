...
import '../widgets/produtcs_filter/filter_button.dart';
import '../widgets/produtcs_filter/filter_cost_interval_dialog.dart';
import '../widgets/produtcs_filter/filter_cost_slider.dart';
import '../widgets/produtcs_filter/filter_item.dart';
      ...
      showDialog(
        ...
        builder: (dialogContext) => Scaffold(
          ...
          body: TapRegion(
            ...
            child: FilterCostIntervalDialog(
                ...
                FadeAnimationX(
                  ...
                  child: FilterItem(
                    ...
                    action: CasualTextButton(
                      onTap: () {
                        widget.productsContext.read<ProductsBloc>().add(
                            const ProductsEvent.changeFilter(ProductsFilter()));
                        Navigator.of(context).pop();
                      },
                      text: 'Reset',
                    ),
